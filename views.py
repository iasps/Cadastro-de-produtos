...
class View:
    ...
    #Avaliação
    # def grupo_login(email, senha):
    #     for grupo in View.grupo_listar():
    #         if grupo.get_email() == email and grupo.get_senha() == senha:
    #         return True
    #     return False
